...
const zh: Translations = {
  ...
  screen_how_title: '如何检测 Zoom 等软件', screen_how_desc: '开启屏幕共享，选择包含通话的窗口或整个屏幕，FakeGuard 将实时分析画面中的人脸和语音',
...
const en: Translations = {
  ...
  screen_how_title: 'How to detect Zoom and other apps', screen_how_desc: 'Start screen sharing, select the window with your call or the entire screen, and FakeGuard will analyze faces and audio in real-time',
